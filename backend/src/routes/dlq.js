...
router.get(
  ...
  asyncHandler(async (req, res) => {
    const { status, integrationConfigId, errorCategory, errorCode, direction, startDate, endDate, limit, offset } =
      req.query;
...
router.get(
  '/stats',
  asyncHandler(async (req, res) => {
    const { integrationConfigId, startDate, endDate } = req.query;
