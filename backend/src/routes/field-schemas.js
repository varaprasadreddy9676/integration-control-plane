...
// ---------------------------------------------------------------------------
router.get('/event-types', requirePermission('event_catalogue:view'), asyncHandler(async (req, res) => {
  try {
...
// ---------------------------------------------------------------------------
router.get('/event-types/:eventType', requirePermission('event_catalogue:view'), asyncHandler(async (req, res) => {
  try {
...
// ---------------------------------------------------------------------------
router.post('/event-types', requirePermission('event_catalogue:manage'), asyncHandler(async (req, res) => {
  try {
    const orgId = req.user?.orgId;
    if (!orgId) {
...
// ---------------------------------------------------------------------------
router.put('/event-types/:eventType', requirePermission('event_catalogue:manage'), asyncHandler(async (req, res) => {
  try {
    const orgId = req.user?.orgId;
    if (!orgId) {
      return res.status(403).json({ error: 'Org context required', code: 'ORG_REQUIRED' });
...
// ---------------------------------------------------------------------------
router.delete('/event-types/:eventType', requirePermission('event_catalogue:manage'), asyncHandler(async (req, res) => {
  try {
    const orgId = req.user?.orgId;
    if (!orgId) {
      return res.status(403).json({ error: 'Org context required', code: 'ORG_REQUIRED' });
...
// ---------------------------------------------------------------------------
router.post('/event-types/import-templates', requirePermission('event_catalogue:manage'), asyncHandler(async (req, res) => {
  try {
    const orgId = req.user?.orgId;
    if (!orgId) {
      return res.status(403).json({ error: 'Org context required', code: 'ORG_REQUIRED' });
...
// ---------------------------------------------------------------------------
router.get('/', requirePermission('event_catalogue:view'), asyncHandler(async (req, res) => {
  try {
    const orgId = req.user?.orgId;
