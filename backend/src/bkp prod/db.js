...
const isConfigured = () => Boolean(db.host && db.user && db.database);
...
function createPoolWithHandlers() {
  const newPool = mysql.createPool({
    ...
    queueLimit: db.queueLimit || 50, // Max queued requests (prevents memory bloat)
...
module.exports = { query, ping, isConfigured, getConnection };
