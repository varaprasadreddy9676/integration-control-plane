...
const eventTypeSchemas = [
  {
    ...
    fields: [
      ...
      { path: 'entityRID', type: 'number', description: 'Entity resource identifier', example: 84 },
...

  {
    ...
    fields: [
      ...
      { path: 'entityRID', type: 'number', description: 'Entity resource identifier', example: 435 },
...

  {
    ...
    fields: [
      ...
      { path: 'entityRID', type: 'number', description: 'Entity resource identifier', example: 849 },
