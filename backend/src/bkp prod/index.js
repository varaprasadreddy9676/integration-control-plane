...
async function bootstrap() {
  ...
  try {
    ...
    // Get entityRid from auth middleware if present, otherwise use default
    const entityRid = req.entityParentRid || 1;

    const healthStatus = await healthMonitor.getSystemHealth(entityRid);
